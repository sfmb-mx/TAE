...
#+begin_src R :session :results output :exports all
  ...
  ## eBayDS$startprice <- log(eBayDS$startprice)
...
#+begin_src R :session :results output :exports all
  ...
  ## eBayValidation$startprice <- log(eBayValidation$startprice)
...
#+begin_src R :session :results output :exports all
  writeLines("\n :: Multiple imputation")
  eBaySimple <- eBayDS[c("startprice", "cellular", "storage", "productline")]
  summary(eBaySimple)
#+end_src
...
#+begin_example
 ...
 :: Multiple imputation
   startprice        cellular         storage        productline
 Min.   :  0.01   Min.   :0.0000   128    : 90   iPad 2    :286
 1st Qu.: 80.00   1st Qu.:0.0000   16     :934   iPad mini :277
 Median :179.99   Median :0.0000   32     :340   iPad 1    :227
 Mean   :211.18   Mean   :0.3196   64     :314   Unknown   :204
 3rd Qu.:300.00   3rd Qu.:1.0000   Unknown:183   iPad Air  :180
 Max.   :999.00   Max.   :1.0000                 iPad Air 2:171
                  NA's   :234                    (Other)   :516
#+end_example
...
#+begin_example
 ...
 1st Qu.: 80.00   1st Qu.:0.0000   16     :934   iPad mini :277
 Median :179.99   Median :0.0000   32     :340   iPad 1    :227
 Mean   :211.18   Mean   :0.3015   64     :314   Unknown   :204
 3rd Qu.:300.00   3rd Qu.:1.0000   Unknown:183   iPad Air  :180
 Max.   :999.00   Max.   :1.0000                 iPad Air 2:171
                                                 (Other)   :516
#+end_example
...
#+begin_example
 ...
 Manufacturer refurbished:  39   1st Qu.:0.0000   None    :1111
 New                     : 289   Median :0.0000   Other   :   3
 New other (see details) :  85   Mean   :0.3015   Sprint  :  30
 Seller refurbished      : 109   3rd Qu.:1.0000   T-Mobile:  19
 Used                    :1158   Max.   :1.0000   Unknown : 348
                                                  Verizon : 144
        color        storage        productline       sold
...
#+begin_src R :session :results output :exports all
  writeLines("\n :: Multiple imputation")
  eBaySimple <- eBayValidation[c("startprice", "cellular", "storage", "productline")]
  summary(eBaySimple)
#+end_src
...
#+begin_example
 ...
 :: Multiple imputation
   startprice         cellular         storage       productline
 Min.   :   0.01   Min.   :0.0000   128    : 38   iPad 2   :154
 1st Qu.:  89.24   1st Qu.:0.0000   16     :394   iPad mini:111
 Median : 179.00   Median :0.0000   32     :138   Unknown  : 92
 Mean   : 208.64   Mean   :0.2938   64     :147   iPad 1   : 88
 3rd Qu.: 289.00   3rd Qu.:1.0000   Unknown: 81   iPad Air : 74
 Max.   : 999.99   Max.   :1.0000                 iPad 4   : 68
                   NA's   :107                    (Other)  :211
#+end_example
...
#+begin_example
 ...
 1st Qu.:  89.24   1st Qu.:0.0000   16     :394   iPad mini:111
 Median : 179.00   Median :0.0000   32     :138   Unknown  : 92
 Mean   : 208.64   Mean   :0.2757   64     :147   iPad 1   : 88
 3rd Qu.: 289.00   3rd Qu.:1.0000   Unknown: 81   iPad Air : 74
 Max.   : 999.99   Max.   :1.0000                 iPad 4   : 68
                                                  (Other)  :211
#+end_example
...
#+begin_example
 ...
 New other (see details) : 43   Mean   :0.2757   Sprint  :  6
...
[25] "great"     "hous"      "icloud"    "includ"    "ipad"      "item"
[31] "light"     "like"      "list"      "lock"      "may"       "mini"
...
[67] "will"      "work"
<<DocumentTermMatrix (documents: 1861, terms: 3)>>
Non-/sparse entries: 733/4850
Sparsity           : 87%
...
#+begin_src R :session :results output :exports all
  ...
  ## nzv <- nearZeroVar(eBayDS3, saveMetrics = TRUE)
...
#+begin_src R :session
  ...
  writeLines("\n :: ----------- LR9 model -----------")
  set.seed(pi)
  eBayLR9 <- glm(formula = sig.formula, data = eBayTrain, family = binomial)
...
#+begin_example
 ...
 :: eBayValidation new structure:
'data.frame':	798 obs. of  30 variables:
...
0.00001 0.17790 0.37480 0.46570 0.78290 0.99810

 :: Submission LR9 file generated...

 :: ------------ RF1 AUC ------------
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
0.01275 0.16800 0.35990 0.46450 0.81390 0.99930
