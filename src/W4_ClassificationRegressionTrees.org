...
#+BEGIN_SRC R :var basename="LocationCARTModel" :session :results none silent :exports none
  filename <- paste("../graphs/", basename, ".png", sep = "")
...
#+CAPTION:  Location CART Model
#+NAME:     fig:LocationCARTModel
#+ATTR_LaTeX: placement: [H]
[[../graphs/LocationCARTModel.png]]
...
#+begin_src R :session :results output :exports all
  ...
  tr <- train(MEDV ~ LAT + LON + CRIM + ZN + INDUS + CHAS + NOX + RM +
                      AGE + DIS + RAD + TAX + PTRATIO, data = train,
              method = "rpart", trControl = tr.control, tuneGrid =
                                                                cp.grid)
#+end_src
...
#+BEGIN_SRC R :var basename="LocationCART-CV" :session :results none silent :exports none
  filename <- paste("../graphs/", basename, ".png", sep = "")
...
#+CAPTION:  Cross validation CP selected value for CART location model
#+NAME:     fig:LocationCART-CV
#+ATTR_LaTeX: placement: [H]
[[../graphs/LocationCART-CV.png]]
