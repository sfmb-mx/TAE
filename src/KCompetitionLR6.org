...
** Logistic Regression model 6 LR6

*** Generalized Boosted Regression LR6
...
We can generate the LR6

#+begin_src R :session
  writeLines("\n :: Generating the LR6 model...")
  ## eBayLR6 <- train(eBayTrain[, predictorsNames],
...
:
:  :: Find out model details:
: Error: object 'eBayLR6' not found
...
#+begin_example
 ...
 :: Class prediction:
 Error in predict(object = eBayLR6, eBayTest[, predictorsNames], type = "raw") :
  object 'eBayLR6' not found
Error in head(predictions) : object 'predictions' not found
Error in postResample(pred = predictions, obs = as.factor(eBayTest[, outcomeName])) :
  object 'predictions' not found

 :: Probabilites prediction:
 Error in predict(object = eBayLR6, eBayTest[, predictorsNames], type = "prob") :
  object 'eBayLR6' not found
Error in head(predictions) : object 'predictions' not found

 :: Test set AUC
Error in roc.default(ifelse(eBayTest[, outcomeName] == "yes", 1, 0), predictions[[2]]) :
  object 'predictions' not found
Error in auc$auc : object of type 'closure' is not subsettable
#+end_example
...
*** Generalized Boosted Regression model LR6
